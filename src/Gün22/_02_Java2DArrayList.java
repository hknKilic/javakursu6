...
public class _02_Java2DArrayList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("tümNotlar.get(0)="+tumNotlar.get(0));//matnotlari
        System.out.println("tümNotlar.get(1)="+tumNotlar.get(1));//fiznotlari
        System.out.println("tümNotlar.get(2)="+tumNotlar.get(2));//kimnotları
        ...
        for (int i = 0; i <tumNotlar.size() ; i++) {
            System.out.println("tümnotlar=" + tumNotlar.get(i));
        }
